...
<div class="example example-one">
            <div class="example-text">
                <h3 class="example-name">THE CABIN</h3>
                <p class="example-desc">"The Cabin" is one whole of an experiment inspired by the designer's favorite hobby photography. The project questions what a website is. But you've likely experienced it already. While there's not a whole world to explore, the scale depends directly on time. The technology is here, and we're ready to build even greater projects with it.</p>
                <a class="visit-button" href="https://thecabinproject.vercel.app" target="_blank">Visit Project</a>
            </div>
            <div class="example-shoot">
                <img src="images/cabingif.gif" alt="" class="example-image">
            </div>
        </div>

        <a href="" onclick="event.preventDefault()" class="back-button examples-back">< Back</a>
`;function cM(){const s=document.createElement("div");s.classList.add("about-page"),s.innerHTML=aM,document.body.appendChild(s),document.querySelector(".back-button").addEventListener("click",function(){event.preventDefault(),uM()})}function uM(){const s=document.querySelector(".about-page");s&&s.parentNode.removeChild(s)}function hM(){const s=document.createElement("div");s.classList.add("contact-page"),s.innerHTML=oM,document.body.appendChild(s),document.querySelector(".back-button").addEventListener("click",function(){event.preventDefault(),dM()})}function dM(){const s=document.querySelector(".contact-page");s&&s.parentNode.removeChild(s)}function fM(){const s=document.createElement("div");s.classList.add("examples-page"),s.innerHTML=lM,document.body.appendChild(s),document.querySelector(".back-button").addEventListener("click",function(){event.preventDefault(),pM()})}function pM(){const s=document.querySelector(".examples-page");s&&s.parentNode.removeChild(s)}function mM(s){return s&&s.__esModule&&Object.prototype.hasOwnProperty.call(s,"default")?s.default:s}var Xd={exports:{}};(function(s){var e=Object.assign||function(n){for(var i,r=1;r<arguments.length;r++)for(var a in i=arguments[r],i)Object.prototype.hasOwnProperty.call(i,a)&&(n[a]=i[a]);return n},t=function(n,i){if(n){typeof window<"u"&&function(){function g(_,m){m=m||{bubbles:!1,cancelable:!1,detail:void 0};var p=document.createEvent("CustomEvent");return p.initCustomEvent(_,m.bubbles,m.cancelable,m.detail),p}return typeof window.CustomEvent!="function"&&(g.prototype=window.Event.prototype,void(window.CustomEvent=g))}(),i||(i={}),i=e({},{minHorizontal:10,minVertical:10,deltaHorizontal:3,deltaVertical:5,preventScroll:!1,lockAxis:!0,touch:!0,mouse:!0},i);var r=[],a=!1,o=function(){a=!0},l=function(g){a=!1,u(g)},c=function(g){a&&(g.changedTouches=[{clientX:g.clientX,clientY:g.clientY}],h(g))};i.mouse&&(n.addEventListener("mousedown",o),n.addEventListener("mouseup",l),n.addEventListener("mousemove",c));var u=function(g){var _=Math.abs,m=Math.max,p=Math.min;if(r.length){for(var M=typeof TouchEvent=="function"&&g instanceof TouchEvent,x=[],y=[],S={top:!1,right:!1,bottom:!1,left:!1},w=0;w<r.length;w++)x.push(r[w].x),y.push(r[w].y);var E=x[0],C=x[x.length-1],v=y[0],b=y[y.length-1],X={x:[E,C],y:[v,b]};if(1<r.length){var K={detail:e({touch:M,target:g.target},X)},I=new CustomEvent("swiperelease",K);n.dispatchEvent(I)}var N=x[0]-x[x.length-1],D="none";D=0<N?"left":"right";var j,z=p.apply(Math,x),W=m.apply(Math,x);if(_(N)>=i.minHorizontal&&(D=="left"?(j=_(z-x[x.length-1]),j<=i.deltaHorizontal&&(S.left=!0)):D=="right"&&(j=_(W-x[x.length-1]),j<=i.deltaHorizontal&&(S.right=!0))),N=y[0]-y[y.length-1],D="none",D=0<N?"top":"bottom",z=p.apply(Math,y),W=m.apply(Math,y),_(N)>=i.minVertical&&(D=="top"?(j=_(z-y[y.length-1]),j<=i.deltaVertical&&(S.top=!0)):D=="bottom"&&(j=_(W-y[y.length-1]),j<=i.deltaVertical&&(S.bottom=!0))),r=[],S.top||S.right||S.bottom||S.left){i.lockAxis&&((S.left||S.right)&&_(E-C)>_(v-b)?S.top=S.bottom=!1:(S.top||S.bottom)&&_(E-C)<_(v-b)&&(S.left=S.right=!1));var $={detail:e({directions:S,touch:M,target:g.target},X)},Z=new CustomEvent("swipe",$);n.dispatchEvent(Z)}else{var B=new CustomEvent("swipecancel",{detail:e({touch:M,target:g.target},X)});n.dispatchEvent(B)}}},h=function(g){var _=g.changedTouches[0];if(r.push({x:_.clientX,y:_.clientY}),1<r.length){var m=r[0].x,p=r[r.length-1].x,M=r[0].y,x=r[r.length-1].y,y={detail:{x:[m,p],y:[M,x],touch:typeof TouchEvent=="function"&&g instanceof TouchEvent,target:g.target}},S=new CustomEvent("swiping",y),w=i.preventScroll===!0||typeof i.preventScroll=="function"&&i.preventScroll(S);w&&g.preventDefault(),n.dispatchEvent(S)}},d=!1;try{var f=Object.defineProperty({},"passive",{get:function(){d={passive:!i.preventScroll}}});window.addEventListener("testPassive",null,f),window.removeEventListener("testPassive",null,f)}catch{}return i.touch&&(n.addEventListener("touchmove",h,d),n.addEventListener("touchend",u)),{off:function(){n.removeEventListener("touchmove",h,d),n.removeEventListener("touchend",u),n.removeEventListener("mousedown",o),n.removeEventListener("mouseup",l),n.removeEventListener("mousemove",c)}}}};s.exports=t,s.exports.default=t})(Xd);var _M=Xd.exports;const gM=mM(_M),Gl=new zh,xM=new Gh(Gl),qd=new fv(Gl),Vl=document.querySelector("canvas"),In=document.querySelector(".intro-wrapper"),Pt=document.querySelector(".about-wrapper"),It=document.querySelector(".examples-wrapper"),mi=document.querySelector(".contact-wrapper"),vM=document.querySelector(".about-tag"),yM=document.querySelector(".contact-tag"),MM=document.querySelector(".examples-tag"),Ps=document.querySelector(".down-mouse-1"),_i=document.querySelector(".down-mouse-2"),gi=document.querySelector(".down-mouse-3"),ba=document.querySelector(".down-mouse-4"),SM=document.querySelector(".loading-page"),ti=new Rx;ti.background=new we(1579544);const Ee=new Gt(45,window.innerWidth/window.innerHeight,.1,1e3);Ee.position.set(0,3,15);Ee.rotation.set(0,0,0);Ee.lookAt(new P(0,2.5,0));const lt={width:window.innerWidth,height:window.innerHeight},nr=new Ih({canvas:Vl,antialias:!0});nr.setSize(lt.width,lt.height);const Oa=new Vh;Oa.intensity=30;Oa.position.y=10;Oa.position.z=10;ti.add(Oa);qd.load("/models/hand.glb",function(s){let e=s.scene;e.position.set(0,-.15,0),e.rotation.set(0,-1.1,0),ti.add(e),nr.render(ti,Ee),s.animations,s.scene,s.scenes,s.cameras,s.asset},function(s){console.log(s.loaded/s.total*100+"% loaded")},function(s){console.log("An error happened")});let ys;qd.load("/models/mert.glb",function(s){let e=s.scene;e.position.set(0,1.15,-.6),e.traverse(n=>{if(n.isMesh){const i=n.material;i&&(i.magFilter=gt,i.minFilter=gt,i.needsUpdate=!0)}}),ti.add(e),ys=new dv(e);const t=ys.clipAction(s.animations[13]);ys.clipAction(s.animations[12]),t.play(),nr.render(ti,Ee),s.animations,s.scene,s.scenes,s.cameras,s.asset},function(s){console.log(s.loaded/s.total*100+"% loaded")},function(s){console.log("An error happened")});const TM=new Qx,Yd=()=>{lt.width/lt.height<1?(Ee.fov=90,Ee.updateProjectionMatrix()):lt.width/lt.height>1&&(Ee.fov=45,Ee.updateProjectionMatrix());let s=TM.getDelta();ys&&ys.update(s),nr.render(ti,Ee),window.requestAnimationFrame(Yd)};Yd();window.onload=()=>{lt.width/lt.height<1?(Ee.fov=90,Ee.updateProjectionMatrix()):lt.width/lt.height>1&&(Ee.fov=45,Ee.updateProjectionMatrix())};let et=0,wa=!1,Je=!1;document.addEventListener("wheel",function(){$d(),!(Je==!0||wa==!0)&&(event.deltaY>0&&et==1?ce.to(Ee.position,{onStart:()=>{Je=!0,ce.to(Ps,{opacity:0,duration:.5}),ce.to(In,{opacity:0,duration:1})},x:-1.5,y:2.5,z:2,duration:3,onUpdate:()=>{Ee.lookAt(new P(0,2.5,0))},onComplete:()=>{In.style.display="none",Pt.style.display="flex",ce.to(Pt,{opacity:1,duration:1,onComplete:()=>{ce.to(_i,{opacity:1,duration:.5}),et=2,Je=!1}})}}):event.deltaY<0&&et==2?ce.to(Ee.position,{x:1,y:2.5,z:0,duration:3,onStart:()=>{Je=!0,ce.to(_i,{opacity:0,duration:.5}),ce.to(Pt,{opacity:0,duration:1})},onUpdate:()=>{Ee.lookAt(new P(0,2.5,0))},onComplete:()=>{Pt.style.display="none",In.style.display="flex",ce.to(In,{opacity:1,duration:2,onComplete:()=>{ce.to(Ps,{opacity:1,duration:.5}),et=1,Je=!1}})}}):event.deltaY>0&&et==2?ce.to(Ee.position,{onStart:()=>{Je=!0,ce.to(_i,{opacity:0,duration:.5}),ce.to(Pt,{opacity:0,duration:1})},x:4,y:5,z:3,duration:2,onUpdate:()=>{Ee.lookAt(new P(0,2.5,0))},onComplete:()=>{Pt.style.display="none",It.style.display="flex",ce.to(It,{opacity:1,duration:1,onComplete:()=>{ce.to(gi,{opacity:1,duration:.5}),et=3,Je=!1}})}}):event.deltaY<0&&et==3?ce.to(Ee.position,{onStart:()=>{Je=!0,ce.to(gi,{opacity:0,duration:.5}),ce.to(It,{opacity:0,duration:1})},x:-1.5,y:2.5,z:2,duration:2,onUpdate:()=>{Ee.lookAt(new P(0,2.5,0))},onComplete:()=>{It.style.display="none",Pt.style.display="flex",ce.to(Pt,{opacity:1,duration:1,onComplete:()=>{ce.to(_i,{opacity:1,duration:.5}),et=2,Je=!1}})}}):event.deltaY>0&&et==3?ce.to(Ee.position,{onStart:()=>{Je=!0,ce.to(gi,{opacity:0,duration:.5}),ce.to(It,{opacity:0,duration:1})},x:-6,y:2,z:1,duration:2,onUpdate:()=>{Ee.lookAt(new P(0,2.5,0))},onComplete:()=>{It.style.display="none",mi.style.display="flex",ce.to(mi,{opacity:1,duration:1,onComplete:()=>{ce.to(ba,{opacity:1,duration:.5}),et=4,Je=!1}})}}):event.deltaY<0&&et==4&&ce.to(Ee.position,{onStart:()=>{Je=!0,ce.to(ba,{opacity:0,duration:.5}),ce.to(mi,{opacity:0,duration:1})},x:4,y:5,z:3,duration:2,onUpdate:()=>{Ee.lookAt(new P(0,2.5,0))},onComplete:()=>{mi.style.display="none",It.style.display="flex",ce.to(It,{opacity:1,duration:1,onComplete:()=>{ce.to(gi,{opacity:1,duration:.5}),et=3,Je=!1}})}}))});gM(Vl);Vl.addEventListener("swipe",function(s){var e=s.detail.directions;s.detail.x,s.detail.y,$d(),!(Je==!0||wa==!0)&&(e.top&&(et==2?ce.to(Ee.position,{x:1,y:2.5,z:0,duration:3,onStart:()=>{Je=!0,ce.to(_i,{opacity:0,duration:.5}),ce.to(Pt,{opacity:0,duration:1})},onUpdate:()=>{Ee.lookAt(new P(0,2.5,0))},onComplete:()=>{Pt.style.display="none",In.style.display="flex",ce.to(In,{opacity:1,duration:2,onComplete:()=>{ce.to(Ps,{opacity:1,duration:.5}),et=1,Je=!1}})}}):et==3?ce.to(Ee.position,{onStart:()=>{Je=!0,ce.to(gi,{opacity:0,duration:.5}),ce.to(It,{opacity:0,duration:1})},x:-1.5,y:2.5,z:2,duration:2,onUpdate:()=>{Ee.lookAt(new P(0,2.5,0))},onComplete:()=>{It.style.display="none",Pt.style.display="flex",ce.to(Pt,{opacity:1,duration:1,onComplete:()=>{ce.to(_i,{opacity:1,duration:.5}),et=2,Je=!1}})}}):et==4&&ce.to(Ee.position,{onStart:()=>{Je=!0,ce.to(ba,{opacity:0,duration:.5}),ce.to(mi,{opacity:0,duration:1})},x:4,y:5,z:3,duration:2,onUpdate:()=>{Ee.lookAt(new P(0,2.5,0))},onComplete:()=>{mi.style.display="none",It.style.display="flex",ce.to(It,{opacity:1,duration:1,onComplete:()=>{ce.to(gi,{opacity:1,duration:.5}),et=3,Je=!1}})}})),e.bottom&&(et==1?ce.to(Ee.position,{onStart:()=>{Je=!0,ce.to(Ps,{opacity:0,duration:.5}),ce.to(In,{opacity:0,duration:1})},x:-1.5,y:2.5,z:2,duration:3,onUpdate:()=>{Ee.lookAt(new P(0,2.5,0))},onComplete:()=>{In.style.display="none",Pt.style.display="flex",ce.to(Pt,{opacity:1,duration:1,onComplete:()=>{ce.to(_i,{opacity:1,duration:.5}),et=2,Je=!1}})}}):et==2?ce.to(Ee.position,{onStart:()=>{Je=!0,ce.to(_i,{opacity:0,duration:.5}),ce.to(Pt,{opacity:0,duration:1})},x:4,y:5,z:3,duration:2,onUpdate:()=>{Ee.lookAt(new P(0,2.5,0))},onComplete:()=>{Pt.style.display="none",It.style.display="flex",ce.to(It,{opacity:1,duration:1,onComplete:()=>{ce.to(gi,{opacity:1,duration:.5}),et=3,Je=!1}})}}):et==3&&ce.to(Ee.position,{onStart:()=>{Je=!0,ce.to(gi,{opacity:0,duration:.5}),ce.to(It,{opacity:0,duration:1})},x:-6,y:2,z:1,duration:2,onUpdate:()=>{Ee.lookAt(new P(0,2.5,0))},onComplete:()=>{It.style.display="none",mi.style.display="flex",ce.to(mi,{opacity:1,duration:1,onComplete:()=>{ce.to(ba,{opacity:1,duration:.5}),et=4,Je=!1}})}})))});const EM=xM.load("/textures/prtcl.png"),jd=new An,Wl=new vl({alphaMap:EM,transparent:!0,alphaTest:.001});Wl.size=.03;Wl.sizeAttenuation=!0;const Kd=3e4,Zd=new Float32Array(Kd*3);for(let s=0;s<Kd*3;s++)Zd[s]=(Math.random()-.5)*25;jd.setAttribute("position",new Nt(Zd,3));const AM=new Nh(jd,Wl);ti.add(AM);window.addEventListener("resize",()=>{lt.width=window.innerWidth,lt.height=window.innerHeight,Ee.aspect=lt.width/lt.height,Ee.updateProjectionMatrix(),nr.setSize(lt.width,lt.height),nr.render(ti,Ee)});screen.orientation.addEventListener("change",function(s){lt.width=window.innerWidth,lt.height=window.innerHeight,Ee.aspect=lt.width/lt.height,Ee.updateProjectionMatrix(),nr.setSize(lt.width,lt.height)});vM.addEventListener("click",function(){cM(),bM()});yM.addEventListener("click",function(){hM()});MM.addEventListener("click",function(){fM()});function $d(){const e=document.body.children;for(let t=0;t<e.length;t++){const n=e[t];n.classList.contains("about-page")||n.classList.contains("contact-page")||n.classList.contains("examples-page")?wa=!0:wa=!1}}function bM(){ce.to(".logo-image",{scale:1.2,duration:.3,stagger:{each:.1},onComplete:()=>{ce.to(".logo-image",{scale:1,duration:.3})}})}Gl.onLoad=function(){SM.style.display="none",ce.to(Ee.position,{x:1,y:2.5,z:0,duration:3,onUpdate:()=>{Ee.lookAt(new P(0,2.5,0))},onComplete:()=>{In.style.display="flex",ce.to(In,{opacity:1,duration:2,onComplete:()=>{ce.to(Ps,{opacity:1,duration:1}),et=1}})}})};
//# sourceMappingURL=index-e7ed8345.js.map
